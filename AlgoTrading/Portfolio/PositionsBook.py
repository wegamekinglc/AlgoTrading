...
if __name__ == "__main__":
    ...
    pb = StocksPositionsBook()
    pb.updatePositionsByOrder('s', dt.datetime(2015, 9, 23), 300, 1)
    pb.updatePositionsByFill('s', dt.datetime(2015, 9, 23), 300, 1)
    pb.updatePositionsByOrder('s', dt.datetime(2015, 9, 24), 100, 1)
    pb.updatePositionsByOrder('s', dt.datetime(2015, 9, 25), 200, 1)
    pb.updatePositionsByFill('s', dt.datetime(2015, 9, 24), 100, 1)
    pb.updatePositionsByFill('s', dt.datetime(2015, 9, 25), 200, 1)
    print(pb._allPositions['s'])
    print(pb.avaliableForSale('s', dt.datetime(2015, 9, 25), 1))
    pb.updatePositionsByOrder('s', dt.datetime(2015, 9, 25), 100, -1)
    print(pb.avaliableForSale('s', dt.datetime(2015, 9, 25), 1))
